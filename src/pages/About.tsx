      ...
      <section className="bg-gradient-to-b from-secondary to-background py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground">Vytváříme kouzelné letní vzpomínky od roku 2010</p>
          </div>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    ...
                    Co začalo jako malý komunitní program, vyrostlo v oblíbenou instituci, která každý rok slouží
                    stovkám rodin.
                  </p>
                  <p>
